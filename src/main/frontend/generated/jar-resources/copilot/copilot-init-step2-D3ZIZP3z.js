import { n as sn, r as ve, p as Le, M as Mt, q as M, u as O, O as Oi, A as Xt, v as oo, E as Oe, w as Wt, e as ee, x as C, y as ao, c as X, z as so, D as ln, f as Ai, F as Pe, G as se, H as lo, I as co, J as Pi, K as uo, L as ho, N as ze, Q as fo, R as K, S as cn, T as po, U as mo, V as Te, W as Nt, X as Ht, Y as In, Z as go, _ as vo, $ as bo, a0 as ct, a1 as Fe, a2 as dn, C as Yt, a3 as Eo, a4 as yo, a5 as wo, a6 as Ro, a7 as Io, a8 as So, P as $o } from "./copilot-OCavwKJw.js";
import { c as rt, a as _i } from "./repeat-B1lyWIHH.js";
import { L as To } from "./lit-renderer-Byomenzj.js";
/**
 * @license
...
const kt = sn(Do), Ft = sn(Oo), Vt = sn(Ao);
...
let xt = class extends Mt {
    ...
    return C`
      ...
      (t) => C`<vaadin-dialog
        ...
        M.moveStackingOrderToTop(t.tag);
            ...
            @resize="${(e) => {
        const { top: r, left: n, width: i, height: o } = e.detail, a = e.currentTarget, d = Number.parseFloat(i), s = Number.parseFloat(o), l = this.getViewportAdjustedPosition({
          top: Number.parseFloat(r),
          left: Number.parseFloat(n),
          width: Number.isFinite(d) ? d : a.getBoundingClientRect().width,
          height: Number.isFinite(s) ? s : a.getBoundingClientRect().height
        });
        a.setAttribute("top", `${l.top}`), a.setAttribute("left", `${l.left}`), a.setAttribute("width", `${l.width}`), a.setAttribute("height", `${l.height}`), M.updatePanel(t.tag, {
          position: l
        });
      }}"
            @dragged="${(e) => {
        ...
        if (!r)
          return;
        const n = e.currentTarget, i = (n._overlayElement?.$?.overlay).getBoundingClientRect();
        let o, a;
        if (i ? (o = i.width, a = i.height) : (o = r.position?.width, a = r.position?.height), !o || !a)
          return;
        const d = {
          top: Number.parseFloat(e.detail.top),
          left: Number.parseFloat(e.detail.left)
        }, s = this.getViewportAdjustedPosition({
          width: i.width,
          height: i.height,
          ...r.position,
          ...d
        });
        n.setAttribute("top", `${s.top}`), n.setAttribute("left", `${s.left}`), M.updatePanel(r.tag, {
          position: s
        });
      }}"
            @mouseenter="${(e) => {
        ...
        () => C`
                ...
                ${t.actionsTag ? Wt(`<${t.actionsTag}></${t.actionsTag}>`) : Oe}
  ...
  getViewportAdjustedPosition(t) {
    ...
    const a = o + r, d = i + n;
    let s = 0, l = 0;
    return o < 0 ? s = -o : a > window.innerWidth - e && (s = window.innerWidth - e - a), i < 0 ? l = -i : d > window.innerHeight - e && (l = window.innerHeight - e - d), o += s, i += l, { top: i, left: o, width: r, height: n };
  }
...
var xe = Se(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), dt = Se(/Edge/i), Dn = Se(/firefox/i), nt = Se(/safari/i) && !Se(/chrome/i) && !Se(/android/i), fn = Se(/iP(ad|od|hone)/i), Fi = Se(/chrome/i) && Se(/android/i), Vi = {
  capture: !1,
  passive: !1
};
function H(t, e, r) {
...
function me(t, e, r, n) {
  if (t) {
    r = r || document;
    do {
      if (e != null && (e[0] === ">" ? t.parentNode === r && Dt(t, e) : Dt(t, e)) || n && t === r)
        return t;
      if (t === r) break;
    } while (t = qi(t));
  }
...
function z(t, e, r, n, i) {
  if (!(!t.getBoundingClientRect && t !== window)) {
    var o, a, d, s, l, c, u;
    if (t !== window && t.parentNode && t !== ye() ? (o = t.getBoundingClientRect(), a = o.top, d = o.left, s = o.bottom, l = o.right, c = o.height, u = o.width) : (a = 0, d = 0, s = window.innerHeight, l = window.innerWidth, c = window.innerHeight, u = window.innerWidth), (e || r) && t !== window && (i = i || t.parentNode, !xe))
      do
        if (i && i.getBoundingClientRect && (S(i, "transform") !== "none" || r && S(i, "position") !== "static")) {
          var h = i.getBoundingClientRect();
          a -= h.top + parseInt(S(i, "border-top-width")), d -= h.left + parseInt(S(i, "border-left-width")), s = a + o.height, l = d + o.width;
          break;
        }
      while (i = i.parentNode);
    if (n && t !== window) {
      var p = Xe(i || t), b = p && p.a, f = p && p.d;
      p && (a /= f, d /= b, u /= b, c /= f, s = a + c, l = d + u);
    }
    return {
      top: a,
      left: d,
...
function pn(t, e) {
  for (var r = t.lastElementChild; r && (r === $.ghost || S(r, "display") === "none" || e && !Dt(r, e)); )
...
function fe(t, e) {
  ...
  for (; t = t.previousElementSibling; )
    t.nodeName.toUpperCase() !== "TEMPLATE" && t !== $.clone && (!e || Dt(t, e)) && r++;
  return r;
}
function Pn(t) {
  var e = 0, r = 0, n = ye();
...
function Ui(t, e, r) {
  ...
  return Array.from(t.children).forEach(function(i) {
    ...
    if (!(!me(i, e.draggable, t, !1) || i.animated || i === r)) {
      var l = z(i);
      n.left = Math.min((o = n.left) !== null && o !== void 0 ? o : 1 / 0, l.left), n.top = Math.min((a = n.top) !== null && a !== void 0 ? a : 1 / 0, l.top), n.right = Math.max((d = n.right) !== null && d !== void 0 ? d : -1 / 0, l.right), n.bottom = Math.max((s = n.bottom) !== null && s !== void 0 ? s : -1 / 0, l.bottom);
    }
  ...
  return {
    ...
    animateAll: function(n) {
      ...
      t.forEach(function(d) {
        var s = 0, l = d.target, c = l.fromRect, u = z(l), h = l.prevFromRect, p = l.prevToRect, b = d.rect, f = Xe(l, !0);
        f && (u.top -= f.f, u.left -= f.e), l.toRect = u, l.thisAnimationDuration && Jt(h, u) && !Jt(c, u) && // Make sure animatingRect is on line between toRect & fromRect
        (b.top - u.top) / (b.left - u.left) === (c.top - u.top) / (c.left - u.left) && (s = oa(b, h, p, i.options)), Jt(u, c) || (l.prevFromRect = c, l.prevToRect = u, s || (s = i.options.animation), i.animate(l, b, u, s)), s && (o = !0, a = Math.max(a, s), clearTimeout(l.animationResetTimer), l.animationResetTimer = setTimeout(function() {
    ...
    animate: function(n, i, o, a) {
      if (a) {
        ...
        var d = Xe(this.el), s = d && d.a, l = d && d.d, c = (i.left - o.left) / (s || 1), u = (i.top - o.top) / (l || 1);
        n.animatingX = !!c, n.animatingY = !!u, S(n, "transform", "translate3d(" + c + "px," + u + "px,0)"), this.forRepaintDummy = ia(n), S(n, "transition", "transform " + a + "ms" + (this.options.easing ? " " + this.options.easing : "")), S(n, "transform", "translate3d(0,0,0)"), typeof n.animated == "number" && clearTimeout(n.animated), n.animated = setTimeout(function() {
  ...
  initializePlugins: function(e, r, n, i) {
    Be.forEach(function(d) {
      ...
      if (!(!e.options[s] && !d.initializeByDefault)) {
        var l = new d(e, r, e.options);
        l.sortable = e, l.options = e.options, e[s] = l, $e(n, l.defaults);
      }
    });
...
function aa(t) {
  var e = t.sortable, r = t.rootEl, n = t.name, i = t.targetEl, o = t.cloneEl, a = t.toEl, d = t.fromEl, s = t.oldIndex, l = t.newIndex, c = t.oldDraggableIndex, u = t.newDraggableIndex, h = t.originalEvent, p = t.putSortable, b = t.extraEventProperties;
  if (e = e || r && r[le], !!e) {
    var f, I = e.options, _ = "on" + n.charAt(0).toUpperCase() + n.substr(1);
    window.CustomEvent && !xe && !dt ? f = new CustomEvent(n, {
      bubbles: !0,
      cancelable: !0
    }) : (f = document.createEvent("Event"), f.initEvent(n, !0, !0)), f.to = a || r, f.from = d || r, f.item = i || r, f.clone = o, f.oldIndex = s, f.newIndex = l, f.oldDraggableIndex = c, f.newDraggableIndex = u, f.originalEvent = h, f.pullMode = p ? p.lastPutMode : void 0;
...
var g, U, x, j, ke, wt, Z, De, Ge, ue, ot, Ce, mt, Q, Ze = !1, Ot = !1, At = [], Ne, pe, Qt, er, _n, Ln, Qe, je, at, st = !1, gt = !1, Rt, te, tr = [], en = !1, Pt = [], qt = typeof document < "u", vt = fn, Mn = dt || xe ? "cssFloat" : "float", la = qt && !Fi && !fn && "draggable" in document.createElement("div"), Xi = function() {
  if (qt) {
    if (xe)
      return !1;
  ...
  var n = S(e), i = parseInt(n.width) - parseInt(n.paddingLeft) - parseInt(n.paddingRight) - parseInt(n.borderLeftWidth) - parseInt(n.borderRightWidth), o = Ye(e, 0, r), a = Ye(e, 1, r), d = o && S(o), s = a && S(a), l = d && parseInt(d.marginLeft) + parseInt(d.marginRight) + z(o).width, c = s && parseInt(s.marginLeft) + parseInt(s.marginRight) + z(a).width;
  if (n.display === "flex")
  ...
  return o && (d.display === "block" || d.display === "flex" || d.display === "table" || d.display === "grid" || l >= i && n[Mn] === "none" || a && n[Mn] === "none" && l + c > i) ? "vertical" : "horizontal";
}, ca = function(e, r, n) {
  var i = n ? e.left : e.top, o = n ? e.right : e.bottom, a = n ? e.width : e.height, d = n ? r.left : r.top, s = n ? r.right : r.bottom, l = n ? r.width : r.height;
  return i === d || o === s || i + a / 2 === d + l / 2;
}, da = function(e, r) {
  var n;
  return At.some(function(i) {
    var o = i[le].options.emptyInsertThreshold;
    if (!(!o || pn(i))) {
      var a = z(i), d = e >= a.left - o && e <= a.right + o, s = r >= a.top - o && r <= a.bottom + o;
      if (d && s)
        return n = i;
    }
  }), n;
  ...
  function r(o, a) {
    return function(d, s, l, c) {
      var u = d.options.group.name && s.options.group.name && d.options.group.name === s.options.group.name;
      if (o == null && (a || u))
        return !0;
      if (o == null || o === !1)
        return !1;
      ...
      if (typeof o == "function")
        return r(o(d, s, l, c), a)(d, s, l, c);
      var h = (a ? d : s).options.group.name;
...
$.prototype = /** @lends Sortable.prototype */
{
  ...
  _onTapStart: function(e) {
    if (e.cancelable) {
      var r = this, n = this.el, i = this.options, o = i.preventOnFilter, a = e.type, d = e.touches && e.touches[0] || e.pointerType && e.pointerType === "touch" && e, s = (d || e).target, l = e.target.shadowRoot && (e.path && e.path[0] || e.composedPath && e.composedPath()[0]) || s, c = i.filter;
      if (Ea(n), !g && !(/mousedown|pointerdown/.test(a) && e.button !== 0 || i.disabled) && !l.isContentEditable && !(!this.nativeDraggable && nt && s && s.tagName.toUpperCase() === "SELECT") && (s = me(s, i.draggable, n, !1), !(s && s.animated) && wt !== s)) {
        if (Ge = fe(s), ot = fe(s, i.draggable), typeof c == "function") {
        ...
        i.handle && !me(l, i.handle, n, !1) || this._prepareDragStart(e, d, s);
      }
    }
  },
  _prepareDragStart: function(e, r, n) {
    var i = this, o = i.el, a = i.options, d = o.ownerDocument, s;
    if (n && !g && n.parentNode === o) {
      ...
      if (j = o, g = n, U = g.parentNode, ke = g.nextSibling, wt = n, mt = a.group, $.dragged = g, Ne = {
        ...
        clientX: (r || e).clientX,
        clientY: (r || e).clientY
      }, _n = Ne.clientX - l.left, Ln = Ne.clientY - l.top, this._lastX = (r || e).clientX, this._lastY = (r || e).clientY, g.style["will-change"] = "all", s = function() {
        if (ae("delayEnded", i, {
          evt: e
        }), $.eventCanceled) {
          i._onDrop();
  ...
  _onTouchMove: function(e) {
    if (Ne) {
      var r = this.options, n = r.fallbackTolerance, i = r.fallbackOffset, o = e.touches ? e.touches[0] : e, a = x && Xe(x, !0), d = x && a && a.a, s = x && a && a.d, l = vt && te && Pn(te), c = (o.clientX - Ne.clientX + i.x) / (d || 1) + (l ? l[0] - tr[0] : 0) / (d || 1), u = (o.clientY - Ne.clientY + i.y) / (s || 1) + (l ? l[1] - tr[1] : 0) / (s || 1);
      if (!$.active && !Ze) {
      ...
      if (x) {
        ...
        S(x, "webkitTransform", h), S(x, "mozTransform", h), S(x, "msTransform", h), S(x, "transform", h), Qt = c, er = u, pe = o;
      }
  ...
  _onDragStart: function(e, r) {
    ...
    }), !r && de(g, o.dragClass, !0), r ? (Ot = !0, n._loopId = setInterval(n._emulateDragOver, 50)) : (L(document, "mouseup", n._onDrop), L(document, "touchend", n._onDrop), L(document, "touchcancel", n._onDrop), i && (i.effectAllowed = "move", o.setData && o.setData.call(n, i, g)), H(document, "drop", n), S(g, "transform", "translateZ(0)")), Ze = !0, n._dragStartId = It(n._dragStarted.bind(n, r, e)), H(document, "selectstart", n), Qe = !0, window.getSelection().removeAllRanges(), nt && S(document.body, "user-select", "none");
  },
  // Returns true - if no further action is needed (either inserted or another condition)
  _onDragOver: function(e) {
    var r = this.el, n = e.target, i, o, a, d = this.options, s = d.group, l = $.active, c = mt === s, u = d.sort, h = Q || l, p, b = this, f = !1;
    if (en) return;
    function I(R, w) {
      ae(R, b, we({
        evt: e,
    ...
    function k(R) {
      return I("dragOverCompleted", {
        insertion: R
      }), R && (c ? l._hideClone() : l._showClone(b), b !== h && (de(g, Q ? Q.options.ghostClass : l.options.ghostClass, !1), de(g, d.ghostClass, !0)), Q !== b && b !== $.active ? Q = b : b === $.active && Q && (Q = null), h === b && (b._ignoreWhileAnimating = n), b.animateAll(function() {
    ...
    if (g.contains(e.target) || n.animated && n.animatingX && n.animatingY || b._ignoreWhileAnimating === n)
      return k(!1);
    if (Ot = !1, l && !d.disabled && (c ? u || (a = U !== j) : Q === this || (this.lastPutMode = mt.checkPull(this, l, g, e)) && s.checkPut(this, l, g, e))) {
  ...
  _nulling: function() {
    ae("nulling", this), j = g = U = x = ke = Z = wt = De = Ne = pe = Qe = ue = Ce = Ge = ot = je = at = Q = mt = $.dragged = $.ghost = $.clone = $.active = null, Pt.forEach(function(e) {
      e.checked = !0;
    }), Pt.length = Qt = er = 0;
  },
...
function bt(t, e, r, n, i, o, a, d) {
  var s, l = t[le], c = l.options.onMove, u;
  return window.CustomEvent && !xe && !dt ? s = new CustomEvent("move", {
    bubbles: !0,
    cancelable: !0
  }) : (s = document.createEvent("Event"), s.initEvent("move", !0, !0)), s.to = e, s.from = t, s.dragged = r, s.draggedRect = n, s.related = i || e, s.relatedRect = o || z(e), s.willInsertAfter = d, s.originalEvent = a, t.dispatchEvent(s), c && (u = c.call(l, s, a)), u;
}
function rr(t) {
  t.draggable = !1;
}
...
function ga(t, e, r, n, i, o, a, d) {
  var s = n ? t.clientY : t.clientX, l = n ? r.height : r.width, c = n ? r.top : r.left, u = n ? r.bottom : r.right, h = !1;
  if (!a) {
    if (d && Rt < l * i) {
      if (!st && (at === 1 ? s > c + l * o / 2 : s < u - l * o / 2) && (st = !0), st)
        h = !0;
      else if (at === 1 ? s < c + Rt : s > u - Rt)
        return -at;
    } else if (s > c + l * (1 - i) / 2 && s < u - l * (1 - i) / 2)
      return va(e);
  }
  return h = h || a, h && (s < c + l * o / 2 || s > u - l * o / 2) ? s > c + l / 2 ? 1 : -1 : 0;
}
function va(t) {
    ...
    _handleAutoScroll: function(r, n) {
      ...
      if (_t = r, n || this.options.forceAutoScrollFallback || dt || xe || nt) {
        ...
        nn && (!tt || o !== nr || a !== ir) && (tt && Nn(), tt = setInterval(function() {
          var l = Ae(document.elementFromPoint(o, a), !0);
          l !== s && (s = l, St()), or(r, i.options, l, n);
        }, 10), nr = o, ir = a);
      } else {
...
var or = ji(function(t, e, r, n) {
  if (e.scroll) {
    var i = (t.touches ? t.touches[0] : t).clientX, o = (t.touches ? t.touches[0] : t).clientY, a = e.scrollSensitivity, d = e.scrollSpeed, s = ye(), l = !1, c;
    rn !== r && (rn = r, St(), et = e.scroll, c = e.scrollFn, et === !0 && (et = Ae(r, !0)));
    var u = 0, h = et;
    do {
      ...
      p === s ? (G = A < q && (J.overflowX === "auto" || J.overflowX === "scroll" || J.overflowX === "visible"), N = V < T && (J.overflowY === "auto" || J.overflowY === "scroll" || J.overflowY === "visible")) : (G = A < q && (J.overflowX === "auto" || J.overflowX === "scroll"), N = V < T && (J.overflowY === "auto" || J.overflowY === "scroll"));
      var Ie = G && (Math.abs(k - i) <= a && Re + A < q) - (Math.abs(_ - i) <= a && !!Re), ce = N && (Math.abs(I - o) <= a && he + V < T) - (Math.abs(f - o) <= a && !!he);
      if (!Y[u])
        for (var v = 0; v <= u; v++)
          Y[v] || (Y[v] = {});
      (Y[u].vx != Ie || Y[u].vy != ce || Y[u].el !== p) && (Y[u].el = p, Y[u].vx = Ie, Y[u].vy = ce, clearInterval(Y[u].pid), (Ie != 0 || ce != 0) && (l = !0, Y[u].pid = setInterval((function() {
        n && this.layer === 0 && $.active._onTouchMove(_t);
        var m = Y[this.layer].vy ? Y[this.layer].vy * d : 0, y = Y[this.layer].vx ? Y[this.layer].vx * d : 0;
        typeof c == "function" && c.call($.dragged.parentNode[le], y, m, t, _t, Y[this.layer].el) !== "continue" || Zi(Y[this.layer].el, y, m);
      }).bind({
        layer: u
      }), 24))), u++;
    } while (e.bubbleScroll && h !== s && (h = Ae(h, !1)));
    nn = l;
  }
}, 30), Ki = function(e) {
  var r = e.originalEvent, n = e.putSortable, i = e.dragEl, o = e.activeSortable, a = e.dispatchSortableEvent, d = e.hideGhostForTarget, s = e.unhideGhostForTarget;
  if (r) {
    var l = n || o;
    d();
...
const Lt = class Lt extends ht {
  constructor() {
    super(...arguments), this.lastDocumentMouseClientX = 0, this.lastDocumentMouseClientY = 0, this.ticking = !1, this.handlePointerProximity = (e) => {
      ...
      const n = this.toolbar.radioGroup, i = n.style.width, o = this.toolbar.getBoundingClientRect(), a = Math.max(o.left - e, 0, e - o.right), d = Math.max(o.top - r, 0, r - o.bottom), s = Math.hypot(a, d), l = Math.max(0, 1 - s / Lt.PROXIMITY_RADIUS), c = Number.parseFloat(getComputedStyle(n).getPropertyValue("--copilot-toolbar-mode-width")), u = this.getIdleWidth(this.toolbar), h = on + (1 - on) * l;
      this.toolbar.style.opacity = h.toFixed(2), this.toolbar.setPlayModeIconProgress(l);
      const p = u + (c - u) * l;
      n.style.width = `${p.toFixed(2)}px`, i !== n.style.width && this.toolbar.updateToolbarTotalWidth(), this.toolbar.toggleAttribute("modes-expanded", p === c);
    };
  }
  onActivate(e) {
...
let ie = class extends Mt {
  constructor() {
    super(...arguments), this.sortableInitialized = !1, this.modeRadioButtonItems = [], this.devToolsDataLoading = !1, this.devToolsDataLoaded = !1, this.isDragging = !1, this.dragPreparing = !1, this.dragStartX = 0, this.dragStartY = 0, this.toolbarStartRight = 0, this.toolbarStartTop = 0, this.wasDraggedInLastInteraction = !1, this.dragThreshold = 5, this.expandModeHandler = new wa(), this.transitionStart = (t) => {
      ...
      if (this.dragPreparing && n > this.dragThreshold && (this.isDragging = !0, this.dragPreparing = !1, this.style.transition = "none"), this.isDragging) {
        ...
        const a = this.getBoundingClientRect(), d = a.width, s = a.height;
        i = Math.max(0, i), window.innerWidth - i - d < 0 && (i = window.innerWidth - d), o = Math.max(0, o);
        const c = window.innerHeight - s;
        o = Math.min(o, c), this.style.right = `${i}px`, this.style.top = `${o}px`, this.style.bottom = "auto", this.style.left = "auto";
      }
    }, this.handleMouseUp = () => {
  ...
  constrainToViewport(t = !1) {
    ...
    const l = window.innerHeight - n;
    o = Math.min(o, l), this.style.right = `${i}px`, this.style.top = `${o}px`, t && (i !== a || o !== d) && Yt.saveToolbarPosition(i, o);
  }
  createRenderRoot() {
    return this;
  }
  ...
  updated(t) {
    super.updated(t), this.updateToolbarTotalWidth(), this.modePanelIconContainer && !this.sortableInitialized && (new $(this.modePanelIconContainer, {
      animation: 150,
  ...
  render() {
    ...
    return C`
      ...
      <div class="flex" id="common-mode-panel-icon-container">
        ...
        <vaadin-popover
          @opened-changed="${(e) => {
      this.expandModeHandler.devToolsPopoverOpenClosedChanged(e.detail.value), e.detail.value && !this.devToolsDataLoaded && (this.devToolsDataLoading = !0, import("./copilot-devtools-B8vVrMBd.js").then(() => {
...
function Ca() {
  ...
  }), K.springSecurityEnabled && e.push({ name: "Spring Security", value: "true", booleanInfo: { ariaLabel: "Enabled" } }), K.springJpaDataEnabled && e.push({ name: "Spring Data JPA", value: "true", booleanInfo: { ariaLabel: "Enabled" } }), e.push(...Oa()), Da(e), e;
}
function Da(t) {
  for (const e of t)
...
function Oa() {
  const t = [], e = cn(), r = Qi(O.idePluginState), n = eo(e);
  return t.push({
    name: "Java Hotswap",
    value: e === "success",
    booleanInfo: {
...
function Aa(t) {
  ...
  const i = e.map((o) => ({ key: o.name, value: o.value })).filter((o) => o.key !== "Live reload").filter((o) => !o.key.startsWith("Vaadin Emplo")).filter((o) => o.key !== "Development Workflow").map((o) => {
    ...
    if (a === "IDE Plugin")
      ...
      const s = K.jdkInfo?.jrebel, l = cn();
      s && l === "success" ? d = "JRebel is in use" : d = eo(l);
    }
...
function ft() {
  return Vn || (Vn = 1, function(t, e) {
    ...
    e = t.exports = {};
    const a = e.re = [], d = e.safeRe = [], s = e.src = [], l = e.safeSrc = [], c = e.t = {};
    let u = 0;
    const h = "[a-zA-Z0-9-]", p = [
      ["\\s", 1],
      ["\\d", i],
      ...
      const A = b(_), V = u++;
      o(I, V, _), c[I] = V, s[V] = _, l[V] = A, a[V] = new RegExp(_, k ? "g" : void 0), d[V] = new RegExp(A, k ? "g" : void 0);
    };
    f("NUMERICIDENTIFIER", "0|[1-9]\\d*"), f("NUMERICIDENTIFIERLOOSE", "\\d+"), f("NONNUMERICIDENTIFIER", `\\d*[a-zA-Z-]${h}*`), f("MAINVERSION", `(${s[c.NUMERICIDENTIFIER]})\\.(${s[c.NUMERICIDENTIFIER]})\\.(${s[c.NUMERICIDENTIFIER]})`), f("MAINVERSIONLOOSE", `(${s[c.NUMERICIDENTIFIERLOOSE]})\\.(${s[c.NUMERICIDENTIFIERLOOSE]})\\.(${s[c.NUMERICIDENTIFIERLOOSE]})`), f("PRERELEASEIDENTIFIER", `(?:${s[c.NONNUMERICIDENTIFIER]}|${s[c.NUMERICIDENTIFIER]})`), f("PRERELEASEIDENTIFIERLOOSE", `(?:${s[c.NONNUMERICIDENTIFIER]}|${s[c.NUMERICIDENTIFIERLOOSE]})`), f("PRERELEASE", `(?:-(${s[c.PRERELEASEIDENTIFIER]}(?:\\.${s[c.PRERELEASEIDENTIFIER]})*))`), f("PRERELEASELOOSE", `(?:-?(${s[c.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${s[c.PRERELEASEIDENTIFIERLOOSE]})*))`), f("BUILDIDENTIFIER", `${h}+`), f("BUILD", `(?:\\+(${s[c.BUILDIDENTIFIER]}(?:\\.${s[c.BUILDIDENTIFIER]})*))`), f("FULLPLAIN", `v?${s[c.MAINVERSION]}${s[c.PRERELEASE]}?${s[c.BUILD]}?`), f("FULL", `^${s[c.FULLPLAIN]}$`), f("LOOSEPLAIN", `[v=\\s]*${s[c.MAINVERSIONLOOSE]}${s[c.PRERELEASELOOSE]}?${s[c.BUILD]}?`), f("LOOSE", `^${s[c.LOOSEPLAIN]}$`), f("GTLT", "((?:<|>)?=?)"), f("XRANGEIDENTIFIERLOOSE", `${s[c.NUMERICIDENTIFIERLOOSE]}|x|X|\\*`), f("XRANGEIDENTIFIER", `${s[c.NUMERICIDENTIFIER]}|x|X|\\*`), f("XRANGEPLAIN", `[v=\\s]*(${s[c.XRANGEIDENTIFIER]})(?:\\.(${s[c.XRANGEIDENTIFIER]})(?:\\.(${s[c.XRANGEIDENTIFIER]})(?:${s[c.PRERELEASE]})?${s[c.BUILD]}?)?)?`), f("XRANGEPLAINLOOSE", `[v=\\s]*(${s[c.XRANGEIDENTIFIERLOOSE]})(?:\\.(${s[c.XRANGEIDENTIFIERLOOSE]})(?:\\.(${s[c.XRANGEIDENTIFIERLOOSE]})(?:${s[c.PRERELEASELOOSE]})?${s[c.BUILD]}?)?)?`), f("XRANGE", `^${s[c.GTLT]}\\s*${s[c.XRANGEPLAIN]}$`), f("XRANGELOOSE", `^${s[c.GTLT]}\\s*${s[c.XRANGEPLAINLOOSE]}$`), f("COERCEPLAIN", `(^|[^\\d])(\\d{1,${r}})(?:\\.(\\d{1,${r}}))?(?:\\.(\\d{1,${r}}))?`), f("COERCE", `${s[c.COERCEPLAIN]}(?:$|[^\\d])`), f("COERCEFULL", s[c.COERCEPLAIN] + `(?:${s[c.PRERELEASE]})?(?:${s[c.BUILD]})?(?:$|[^\\d])`), f("COERCERTL", s[c.COERCE], !0), f("COERCERTLFULL", s[c.COERCEFULL], !0), f("LONETILDE", "(?:~>?)"), f("TILDETRIM", `(\\s*)${s[c.LONETILDE]}\\s+`, !0), e.tildeTrimReplace = "$1~", f("TILDE", `^${s[c.LONETILDE]}${s[c.XRANGEPLAIN]}$`), f("TILDELOOSE", `^${s[c.LONETILDE]}${s[c.XRANGEPLAINLOOSE]}$`), f("LONECARET", "(?:\\^)"), f("CARETTRIM", `(\\s*)${s[c.LONECARET]}\\s+`, !0), e.caretTrimReplace = "$1^", f("CARET", `^${s[c.LONECARET]}${s[c.XRANGEPLAIN]}$`), f("CARETLOOSE", `^${s[c.LONECARET]}${s[c.XRANGEPLAINLOOSE]}$`), f("COMPARATORLOOSE", `^${s[c.GTLT]}\\s*(${s[c.LOOSEPLAIN]})$|^$`), f("COMPARATOR", `^${s[c.GTLT]}\\s*(${s[c.FULLPLAIN]})$|^$`), f("COMPARATORTRIM", `(\\s*)${s[c.GTLT]}\\s*(${s[c.LOOSEPLAIN]}|${s[c.XRANGEPLAIN]})`, !0), e.comparatorTrimReplace = "$1$2$3", f("HYPHENRANGE", `^\\s*(${s[c.XRANGEPLAIN]})\\s+-\\s+(${s[c.XRANGEPLAIN]})\\s*$`), f("HYPHENRANGELOOSE", `^\\s*(${s[c.XRANGEPLAINLOOSE]})\\s+-\\s+(${s[c.XRANGEPLAINLOOSE]})\\s*$`), f("STAR", "(<|>)?=?\\s*\\*"), f("GTE0", "^\\s*>=\\s*0\\.0\\.0\\s*$"), f("GTE0PRE", "^\\s*>=\\s*0\\.0\\.0-0\\s*$");
...
function oe() {
  ...
  class d {
    constructor(l, c) {
      ...
      t("SemVer", l, c), this.options = c, this.loose = !!c.loose, this.includePrerelease = !!c.includePrerelease;
      const u = l.trim().match(c.loose ? n[i.LOOSE] : n[i.FULL]);
      if (!u)
        throw new TypeError(`Invalid Version: ${l}`);
      if (this.raw = l, this.major = +u[1], this.minor = +u[2], this.patch = +u[3], this.major > r || this.major < 0)
    ...
    compare(l) {
      if (t("SemVer.compare", this.version, this.options, l), !(l instanceof d)) {
    ...
    comparePre(l) {
      ...
      let c = 0;
      do {
        const u = this.prerelease[c], h = l.prerelease[c];
        if (t("prerelease compare", c, u, h), u === void 0 && h === void 0)
          return 0;
        if (h === void 0)
          return 1;
        if (u === void 0)
    ...
    compareBuild(l) {
      ...
      let c = 0;
      do {
        const u = this.build[c], h = l.build[c];
        if (t("build compare", c, u, h), u === void 0 && h === void 0)
          return 0;
        if (h === void 0)
          return 1;
        if (u === void 0)
    ...
    inc(l, c, u) {
      if (l.startsWith("pre")) {
        ...
        if (c) {
          const h = `-${c}`.match(this.options.loose ? n[i.PRERELEASELOOSE] : n[i.PRERELEASE]);
          if (!h || h[1] !== c)
      ...
      switch (l) {
        case "premajor":
          this.prerelease.length = 0, this.patch = 0, this.minor = 0, this.major++, this.inc("pre", c, u);
          break;
        case "preminor":
          this.prerelease.length = 0, this.patch = 0, this.minor++, this.inc("pre", c, u);
          break;
        case "prepatch":
          this.prerelease.length = 0, this.inc("patch", c, u), this.inc("pre", c, u);
          break;
        ...
        case "pre": {
          ...
          if (c) {
            let p = [c, h];
            u === !1 && (p = [c]), a(this.prerelease[0], c) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = p) : this.prerelease = p;
          }
          break;
        }
        default:
...
function Ha() {
  ...
  return mr = (r, n) => {
    ...
    if (a === 0)
      return null;
    const d = a > 0, s = d ? i : o, l = d ? o : i, c = !!s.prerelease.length;
...
function Ua() {
  ...
  return _r = (o, a) => {
    ...
    if (d === null)
      return null;
    const s = d[2], l = d[3] || "0", c = d[4] || "0", u = a.includePrerelease && d[5] ? `-${d[5]}` : "", h = a.includePrerelease && d[6] ? `+${d[6]}` : "";
    return e(`${s}.${l}.${c}${u}${h}`, a);
  }, _r;
}
var Lr, fi;
function Xa() {
...
function Ee() {
  ...
  class e {
    ...
    parseRange(m) {
      ...
      if (R)
        return R;
      const w = this.options.loose, D = w ? s[l.HYPHENRANGELOOSE] : s[l.HYPHENRANGE];
      m = m.replace(D, Ie(this.options.includePrerelease)), a("hyphen replace", m), m = m.replace(s[l.COMPARATORTRIM], c), a("comparator trim", m), m = m.replace(s[l.TILDETRIM], u), a("tilde trim", m), m = m.replace(s[l.CARETTRIM], h), a("caret trim", m);
      let F = m.split(" ").map((W) => k(W, this.options)).join(" ").split(/\s+/).map((W) => he(W, this.options));
      w && (F = F.filter((W) => (a("loose invalid filter", W, this.options), !!W.match(s[l.COMPARATORLOOSE])))), a("range list", F);
  ...
  const r = Xa(), n = new r(), i = vn(), o = Gt(), a = jt(), d = oe(), {
    ...
    return y;
  }, k = (v, m) => (v = v.replace(s[l.BUILD], ""), a("comp", v, m), v = N(v, m), a("caret", v), v = V(v, m), a("tildes", v), v = T(v, m), a("xrange", v), v = Re(v, m), a("stars", v), v), A = (v) => !v || v.toLowerCase() === "x" || v === "*", V = (v, m) => v.trim().split(/\s+/).map((y) => G(y, m)).join(" "), G = (v, m) => {
    const y = m.loose ? s[l.TILDELOOSE] : s[l.TILDE];
    return v.replace(y, (E, R, w, D, F) => {
      a("tilde", v, E, R, w, D, F);
      let P;
      return A(R) ? P = "" : A(w) ? P = `>=${R}.0.0 <${+R + 1}.0.0-0` : A(D) ? P = `>=${R}.${w}.0 <${R}.${+w + 1}.0-0` : F ? (a("replaceTilde pr", F), P = `>=${R}.${w}.${D}-${F} <${R}.${+w + 1}.0-0`) : P = `>=${R}.${w}.${D} <${R}.${+w + 1}.0-0`, a("tilde return", P), P;
    });
  }, N = (v, m) => v.trim().split(/\s+/).map((y) => q(y, m)).join(" "), q = (v, m) => {
    a("caret", v, m);
    const y = m.loose ? s[l.CARETLOOSE] : s[l.CARET], E = m.includePrerelease ? "-0" : "";
    return v.replace(y, (R, w, D, F, P) => {
      a("caret", v, R, w, D, F, P);
      let B;
      return A(w) ? B = "" : A(D) ? B = `>=${w}.0.0${E} <${+w + 1}.0.0-0` : A(F) ? w === "0" ? B = `>=${w}.${D}.0${E} <${w}.${+D + 1}.0-0` : B = `>=${w}.${D}.0${E} <${+w + 1}.0.0-0` : P ? (a("replaceCaret pr", P), w === "0" ? D === "0" ? B = `>=${w}.${D}.${F}-${P} <${w}.${D}.${+F + 1}-0` : B = `>=${w}.${D}.${F}-${P} <${w}.${+D + 1}.0-0` : B = `>=${w}.${D}.${F}-${P} <${+w + 1}.0.0-0`) : (a("no pr"), w === "0" ? D === "0" ? B = `>=${w}.${D}.${F}${E} <${w}.${D}.${+F + 1}-0` : B = `>=${w}.${D}.${F}${E} <${w}.${+D + 1}.0-0` : B = `>=${w}.${D}.${F} <${+w + 1}.0.0-0`), a("caret return", B), B;
    });
  }, T = (v, m) => (a("replaceXRanges", v, m), v.split(/\s+/).map((y) => J(y, m)).join(" ")), J = (v, m) => {
    v = v.trim();
    const y = m.loose ? s[l.XRANGELOOSE] : s[l.XRANGE];
    return v.replace(y, (E, R, w, D, F, P) => {
      a("xRange", v, E, R, w, D, F, P);
      const B = A(w), re = B || A(D), W = re || A(F), Ke = W;
      return R === "=" && Ke && (R = ""), P = m.includePrerelease ? "-0" : "", B ? R === ">" || R === "<" ? E = "<0.0.0-0" : E = "*" : R && Ke ? (re && (D = 0), F = 0, R === ">" ? (R = ">=", re ? (w = +w + 1, D = 0, F = 0) : (D = +D + 1, F = 0)) : R === "<=" && (R = "<", re ? w = +w + 1 : D = +D + 1), R === "<" && (P = "-0"), E = `${R + w}.${D}.${F}${P}`) : re ? E = `>=${w}.0.0${P} <${+w + 1}.0.0-0` : W && (E = `>=${w}.${D}.0${P} <${w}.${+D + 1}.0-0`), a("xRange return", E), E;
    });
  }, Re = (v, m) => (a("replaceStars", v, m), v.trim().replace(s[l.STAR], "")), he = (v, m) => (a("replaceGTE0", v, m), v.trim().replace(s[m.includePrerelease ? l.GTE0PRE : l.GTE0], "")), Ie = (v) => (m, y, E, R, w, D, F, P, B, re, W, Ke) => (A(E) ? y = "" : A(R) ? y = `>=${E}.0.0${v ? "-0" : ""}` : A(w) ? y = `>=${E}.${R}.0${v ? "-0" : ""}` : D ? y = `>=${y}` : y = `>=${y}${v ? "-0" : ""}`, A(B) ? P = "" : A(re) ? P = `<${+B + 1}.0.0-0` : A(W) ? P = `<${B}.${+re + 1}.0-0` : Ke ? P = `<=${B}.${re}.${W}-${Ke}` : v ? P = `<${B}.${re}.${+W + 1}-0` : P = `<=${P}`, `${y} ${P}`.trim()), ce = (v, m, y) => {
...
function Ya() {
  ...
  return Fr = (n, i, o) => {
    ...
    return n.forEach((l) => {
      s.test(l) && (!a || d.compare(l) === -1) && (a = l, d = new t(a, o));
    }), a;
  }, Fr;
}
var Vr, Ei;
...
function Ja() {
  ...
  return qr = (i, o) => {
    ...
    for (let d = 0; d < i.set.length; ++d) {
      ...
      let l = null;
      s.forEach((c) => {
        const u = new t(c.semver.version);
        switch (c.operator) {
          case ">":
...
function Rn() {
  if (Ri) return jr;
  Ri = 1;
  const t = oe(), e = Gt(), { ANY: r } = e, n = Ee(), i = Ut(), o = Zt(), a = En(), d = wn(), s = yn();
  return jr = (c, u, h, p) => {
    c = new t(c, p), u = new n(u, p);
    let b, f, I, _, k;
    switch (h) {
      case ">":
        b = o, f = d, I = a, _ = ">", k = ">=";
    ...
    for (let A = 0; A < u.set.length; ++A) {
      ...
      }), G.operator === _ || G.operator === k || (!N.operator || N.operator === _) && f(c, N.semver))
        return !1;
      if (N.operator === k && I(c, N.semver))
        return !1;
    }
    return !0;
  }, jr;
...
function rs() {
  ...
  return Xr = (r, n, i) => {
    const o = [];
    let a = null, d = null;
    const s = r.sort((h, p) => e(h, p, i));
    for (const h of s)
      t(h, n, i) ? (d = h, a || (a = h)) : (d && o.push([a, d]), d = null, a = null);
    a && o.push([a, null]);
    const l = [];
    for (const [h, p] of o)
      h === p ? l.push(h) : !p && h === s[0] ? l.push("*") : p ? h === s[0] ? l.push(`<=${p}`) : l.push(`${h} - ${p}`) : l.push(`>=${h}`);
    const c = l.join(" || "), u = typeof n.raw == "string" ? n.raw : String(n);
    return c.length < u.length ? c : n;
  }, Xr;
}
var Wr, xi;
function ns() {
  ...
  const t = Ee(), e = Gt(), { ANY: r } = e, n = Ut(), i = be(), o = (u, h, p = {}) => {
    ...
    return !0;
  }, a = [new e(">=0.0.0-0")], d = [new e(">=0.0.0")], s = (u, h, p) => {
    if (u === h)
      return !0;
    ...
    let f, I;
    for (const T of u)
      T.operator === ">" || T.operator === ">=" ? f = l(f, T, p) : T.operator === "<" || T.operator === "<=" ? I = c(I, T, p) : b.add(T.semver);
    if (b.size > 1)
      return null;
    let _;
    if (f && I) {
...
function is() {
  if (Ci) return Yr;
  Ci = 1;
  const t = ft(), e = Bt(), r = oe(), n = to(), i = Je(), o = La(), a = Ma(), d = Na(), s = Ha(), l = ka(), c = Fa(), u = Va(), h = qa(), p = be(), b = Ba(), f = ja(), I = bn(), _ = Za(), k = Ga(), A = Zt(), V = En(), G = ro(), N = no(), q = yn(), T = wn(), J = io(), Re = Ua(), he = Gt(), Ie = Ee(), ce = Ut(), v = Wa(), m = Ya(), y = za(), E = Ja(), R = Ka(), w = Rn(), D = Qa(), F = es(), P = ts(), B = rs(), re = ns();
  return Yr = {
    parse: i,
    valid: o,
    clean: a,
...
var os = is();
const lt = /* @__PURE__ */ So(os), Di = (t) => lt.valid(t) ?? lt.valid(lt.coerce(t)), as = window.Vaadin.copilot.eventbus;
as.on("serverInfo", (t) => {
  ...
  Ai(`${$o}get-release-note-url`, { version: i }, (o) => {
    ...
    if (!a.error && a.url)
      if (n) {
        const d = Di(i), s = Di(n), l = d !== null && s !== null ? lt.gte(d, s) : i === n;
        O.setProjectVersionReleaseNoteInfo({
          mostRecentVersion: l,
          vaadinVersion: i,
          url: a.url
        }), d !== null && s !== null && lt.gt(d, s) && (Pe({
          type: se.INFORMATION,
        ...
        Fe.setMostRecentReleaseNoteDismissed(!1), Fe.setMostRecentVaadinVersion(i), O.setProjectVersionReleaseNoteInfo({
          mostRecentVersion: !0,
          vaadinVersion: i,
          url: a.url
        });
