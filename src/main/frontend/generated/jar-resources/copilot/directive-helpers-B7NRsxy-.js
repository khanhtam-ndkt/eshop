import { ao as c } from "./copilot-OCavwKJw.js";
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: l } = c, d = (e) => e.strings === void 0, n = () => document.createComment(""), v = (e, i, t) => {
  const r = e._$AA.parentNode, $ = i === void 0 ? e._$AB : i._$AA;
  if (t === void 0) {
    const s = r.insertBefore(n(), $), _ = r.insertBefore(n(), $);
    t = new l(s, _, e, e.options);
  } else {
    const s = t._$AB.nextSibling, _ = t._$AM, o = _ !== e;
    if (o) {
      let A;
